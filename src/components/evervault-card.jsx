    ...
    return (
        ...
        >
            ...
            >
                ...
                {text && <div className="relative z-10 flex items-center justify-center">
...
export function CardPattern({ mouseX, mouseY, randomString }) {
    let maskImage = useMotionTemplate`radial-gradient(50px at ${mouseX}px ${mouseY}px, white, transparent)`;
...
const characters = ["css", "js", "reactJS", "wordpress", "php", "tailwind", "gatsbyJs", "nextJs", "husband"];
